            ...
            <div class="welcome-card">
                <div class="welcome-content">
                    ...
                    <div class="welcome-stats">
                        ...
                        <div class="welcome-stat">
                            <span class="stat-number"><?php echo count(array_filter($reports, function ($r) {
                ...
                <div class="content-card">
                    ...
                    <div class="card-body">
                        <?php if (count($reports) > 0): ?>
                            ...
                            <div class="view-all">
                                <a href="/town_issues/user/report_history.php">View All Reports →</a>
                            </div>
                        <?php else: ?>
                ...
                <div class="content-card">
                    ...
                    <div class="card-body">
                        <div class="quick-actions">
                            <a href="/town_issues/user/map_reports.php" class="action-btn">
                                <i class="fas fa-map-marked-alt"></i>
                            ...
                            <a href="/town_issues/user/report_history.php" class="action-btn">
                                <i class="fas fa-history"></i>
                                <span>View Report History</span>
                            </a>
                            <a href="/town_issues/user/profile.php" class="action-btn">
                                <i class="fas fa-user"></i>
...
<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>
    <script src="/town_issues/assets/js/map-common.js?v=2"></script>
    <script src="/town_issues/assets/js/user-dashboard.js?v=4"></script>
