    ...
    <nav class="user-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="menu-item active">
                <a href="/town_issues/user/change_password.php">
        ...
        <div class="dashboard-content">
            ...
            <div class="content-card">
                <div class="card-header">
                    ...
                    <a href="/town_issues/user/profile.php" class="btn-cancel">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/town_issues/user/change_password.php" class="password-form" id="passwordForm">
                        <div class="form-grid">
