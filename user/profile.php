        ...
        <div class="dashboard-content">
            ...
            <div class="content-card">
                ...
                <div class="card-body">
                        ...
                        <div class="profile-info">
                            ...
                            <p>Citizen User • 
                                <?php if ($show_password_form): ?>
                                    <a href="/town_issues/user/profile.php" class="change-password-link">Back to Profile</a>
                                <?php else: ?>
                                    <a href="/town_issues/user/profile.php?action=change-password" class="change-password-link">Change Password</a>
                                <?php endif; ?>
                            </p>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="/town_issues/user/profile.php" class="profile-form" id="profileForm" <?php echo !$is_editing ? 'style="display: none;"' : ''; ?>>
                    ...
                    <form method="POST" action="/town_issues/user/profile.php" class="password-form" id="passwordForm" <?php echo !$show_password_form ? 'style="display: none;"' : ''; ?>>
