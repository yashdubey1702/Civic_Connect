...
$dashboardUrl = '/town_issues/login.php';
...
if ($isLoggedIn) {
    ...
    switch ($role) {
        case 'super_admin':
            $dashboardUrl = '/town_issues/admin_dashboard.php';
            break;
        case 'municipal_admin':
        case 'ward_admin':
            $dashboardUrl = '/town_issues/municipal_admin_dashboard.php';
            break;
        case 'volunteer':
        ...
        case 'citizen':
        default:
            $dashboardUrl = '/town_issues/user_dashboard.php';
            break;
    }
}
?>
        ...
        <section class="access-card" aria-labelledby="access-title">
            ...
            <div class="access-content">
                ...
                <div class="actions">
                    ...
                    <?php if ($isLoggedIn): ?>
                        <a class="btn btn-secondary" href="/town_issues/logout.php">
