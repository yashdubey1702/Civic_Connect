...
if (!$task) {
    header("Location: my_tasks.php?error=" . rawurlencode("Task not found or no longer assigned to you"));
    exit;
}
...
<nav class="user-sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="menu-item active"><a href="my_tasks.php"><i class="fas fa-clipboard-list"></i><span>My Tasks</span></a></li>
...
<main class="user-main volunteer-main">
    <header class="user-header">
        ...
        <div class="volunteer-header-actions">
            <a class="btn-volunteer-secondary" href="my_tasks.php"><i class="fas fa-arrow-left"></i> My Tasks</a>
            <?= badge($task['status']) ?>
        </div>
    </header>
            ...
            <div class="volunteer-card">
                ...
                <div class="volunteer-card-body">
                    <?php if ($task['status'] === 'Assigned'): ?>
                        <form method="POST" action="task_action.php" class="volunteer-form">
                    ...
                    <?php elseif ($task['status'] === 'In Progress'): ?>
                        <form method="POST" action="task_action.php" enctype="multipart/form-data" class="volunteer-form">
                            <input type="hidden" name="task_id" value="<?= (int)$taskId ?>">
