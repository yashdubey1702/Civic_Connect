    ...
    if ($full_name === '' || $email === '' || $password === '' || $confirm_password === '') {
        ...
        if ($result->num_rows > 0) {
            ...
            try {
                ...
                $db->commit();
                if ($account_type === 'volunteer') {
                    header("Location: /town_issues/auth/login.php?volunteer_registered=1");
                } else {
                    header("Location: /town_issues/auth/login.php?registered=1");
                }
                exit;
            } catch (Throwable $e) {
                $db->rollback();
...
<body class="register-page">
    <div class="auth-container">
        ...
        <div class="auth-form-panel">
            <div class="auth-form-container">
                ...
                <form method="POST" action="/town_issues/auth/register.php" class="auth-form">
                ...
                <div class="auth-footer">
                    <p>Already have an account? <a href="/town_issues/auth/login.php">Sign in</a></p>
                </div>
            </div>
    ...
    <script>
        ...
        // Shows or hides volunteer registration fields.
