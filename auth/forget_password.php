...
<link rel="stylesheet" href="/town_issues/assets/css/forget_password.css">
  ...
  <div class="reset-card bg-white w-100" style="max-width:420px;">
    <div class="p-4 p-md-5">
      ...
      <div class="text-center mt-4">
        <a href="/town_issues/auth/login.php" class="text-muted fw-semibold text-decoration-none d-inline-flex align-items-center gap-1">
